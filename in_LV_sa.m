...
%RMi=0.30     %mitral valve resistance (with stenosis) (mmHg/(liter/minute))
%RAo=0.01     %aortic valve resistance (mmHg/(liter/minute))
RAo=0.5    %aortic valve resistance (with stenosis) (mmHg/(liter/minute))
...
%Csa=0.00175/2 %Systemic arterial compliance reduced by 2
%CLVS=0.00003 %Min (systolic)  value of CLV (liters/mmHg)
CLVS=0.00003/1.08 %to correct for Ao stenosis
%CLVD=0.0146  %Max (diastolic) value of CLV (liters/mmHg)
CLVD=0.0146/1.08  %to correct for Ao stenosis
...
%PLA = 28      % new PLA to correct Mi stenosis
